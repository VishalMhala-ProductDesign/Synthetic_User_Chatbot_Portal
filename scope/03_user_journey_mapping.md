...
|---|---|
| User goals | What the user is trying to accomplish at each stage |
| Activities/Actions | The concrete steps and behaviors the user actually performs at each stage
| Thinks | What's going through the user's mind — assumptions, expectations, or uncertainties at that point
| Feels | The emotional state the user experiences at each stage (e.g., confident, anxious, frustrated, relieved)
...
|------|------|------|------|------|------|------|------|
| Stage-01 | AI identifing user goal | AI identifing Activities/Actions | AI identifing Thinks | AI identifing Feels | AI identifing Pain Points/Friction | AI identifing Decision Point | AI identifing Opportunities |
| Stage-02 | AI identifing user goal | AI identifing Activities/Actions | AI identifing Thinks | AI identifing Feels | AI identifing Pain Points/Friction | AI identifing Decision Point | AI identifing Opportunities |
| Stage-03 | AI identifing user goal | AI identifing Activities/Actions | AI identifing Thinks | AI identifing Feels | AI identifing Pain Points/Friction | AI identifing Decision Point | AI identifing Opportunities |
| Stage-04 | AI identifing user goal | AI identifing Activities/Actions | AI identifing Thinks | AI identifing Feels | AI identifing Pain Points/Friction | AI identifing Decision Point | AI identifing Opportunities |
